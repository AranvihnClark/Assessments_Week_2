...
const canWeDeliver = zipcode => {
    if(deliveryAreaZipCodes.includes(zipcode)) return console.log(`You're in our delivery zone.\n`);
...
const canWeDeliverTwo = arr => zipcode => {
    if(arr.includes(zipcode)) return console.log(`You're in our delivery zone.\n`);
    else return console.log(`Sorry, we can't deliver to that address.\n`);
    }

const checkZipcode = canWeDeliverTwo(deliveryAreaZipCodes);
